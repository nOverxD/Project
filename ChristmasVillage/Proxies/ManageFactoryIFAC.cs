...
namespace ChristmasVillageGUI.Proxies
{
    ...
    public interface ManageFactoryIFAC
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="urn:ChristmasVillageIFAC/ManageFactoryIFAC/ManageFactoryIFAC/deleteManageFactory", ReplyAction="urn:ChristmasVillageIFAC/ManageFactoryIFAC/ManageFactoryIFAC/deleteManageFactoryR" +
            "esponse")]
        void deleteManageFactory(int id_factory);
        
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="urn:ChristmasVillageIFAC/ManageFactoryIFAC/ManageFactoryIFAC/deleteManageFactory", ReplyAction="urn:ChristmasVillageIFAC/ManageFactoryIFAC/ManageFactoryIFAC/deleteManageFactoryR" +
            "esponse")]
        System.IAsyncResult BegindeleteManageFactory(int id_factory, System.AsyncCallback callback, object asyncState);
        
        void EnddeleteManageFactory(System.IAsyncResult result);
    }
    ...
    public partial class ManageFactoryIFACClient : System.ServiceModel.ClientBase<ChristmasVillageGUI.Proxies.ManageFactoryIFAC>, ChristmasVillageGUI.Proxies.ManageFactoryIFAC
    {
        ...
        {
            base.Channel.deleteManageFactory(id_factory);
        }
        
        public System.IAsyncResult BegindeleteManageFactory(int id_factory, System.AsyncCallback callback, object asyncState)
        {
            return base.Channel.BegindeleteManageFactory(id_factory, callback, asyncState);
        }
        
        public void EnddeleteManageFactory(System.IAsyncResult result)
        {
            base.Channel.EnddeleteManageFactory(result);
        }
    }
}
